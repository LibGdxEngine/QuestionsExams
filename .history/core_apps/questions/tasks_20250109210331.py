...
def save_questions_task(temp_question_ids):
    for temp_question_id in temp_question_ids:
        try:
            ...
            specificity, _ = Specificity.objects.get_or_create(name=temp_question.specificity)
