...
class AnswerImageInline(admin.TabularInline):
    ...
    fields = ["image", "image_preview"]  # Ensure the image field is displayed
...
class QuestionAnswerInline(admin.TabularInline):
    ...
    edit_button.short_description = "Edit Answer"
...
class QuestionAdmin(ImportExportModelAdmin):
    ...
    inlines = [QuestionAnswerInline]  # Ensure this is included
