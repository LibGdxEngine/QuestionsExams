...
from .models import QuestionAnswer, AnswerImage, TempQuestion, Question, Answer
import logging
import pandas as pd
...
def confirm_question(request, question_id):
    if request.method == "POST":
        ...
        return JsonResponse({"success": True, "message": "Question and answers confirmed and saved."})
