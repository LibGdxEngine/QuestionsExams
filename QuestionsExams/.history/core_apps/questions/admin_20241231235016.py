...
class QuestionAdmin(ImportExportModelAdmin):
    ...
    def add_answer_button(self, obj):
        return mark_safe(
            "<button type=\"button\" onclick=\"window.open('/admin/questions/add-answer/', 'Add Answer', 'width=600,height=400');\">Add Answer</button>"
        )
    ...
    def get_urls(self):
        ...
        custom_urls = [
            ...
            path(
                "edit-images/<int:question_id>/",
                self.admin_site.admin_view(self.edit_images_view),
                name="edit_images",
            ),
        ]
    ...
    def add_answer_view(self, request):
        return render(request, "admin/questions/question/add_answer_popup.html")
