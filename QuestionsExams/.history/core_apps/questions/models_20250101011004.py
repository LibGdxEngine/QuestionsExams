...
class TempQuestion(models.Model):
    ...
    specificity = models.ForeignKey(Specificity, on_delete=models.CASCADE, null=True, blank=True)
    level = models.ForeignKey(Level, on_delete=models.CASCADE, null=True, blank=True)
    is_confirmed = models.BooleanField(default=False)


class TempAnswer(models.Model):
    question = models.ForeignKey(TempQuestion, related_name='temp_answers', on_delete=models.CASCADE)
    text = models.TextField()
    is_correct = models.BooleanField(default=False)
